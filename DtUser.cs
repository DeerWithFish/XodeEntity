...
[BindTable("dt_User", Description = "用户。用户帐号信息，以身份验证为中心，拥有多种角色，可加入多个租户", ConnName = "Membership", DbType = DatabaseType.SqlServer)]
public partial class DtUser
{
    ...
    [BindColumn("Password", "密码", "nvarchar(200)")]
    ...
    [Description("邮件。支持登录")]
    [DataObjectField(false, false, true, 50)]
    [BindColumn("Mail", "邮件。支持登录", "nvarchar(50)")]
    ...
    [Description("手机。支持登录")]
    [DataObjectField(false, false, true, 50)]
    [BindColumn("Mobile", "手机。支持登录", "nvarchar(50)")]
    ...
    [DataObjectField(false, false, true, 50)]
    [BindColumn("Code", "代码。身份证、员工编码等，支持登录", "nvarchar(50)")]
    ...
    [BindColumn("Birthday", "生日。公历年月日", "datetime", Precision = 0, Scale = 3)]
    ...
    [DataObjectField(false, false, false, 10)]
    [BindColumn("OnlineTime", "在线时间。累计在线总时间，单位秒", "int")]
